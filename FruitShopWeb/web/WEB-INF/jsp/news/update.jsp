...
<div style="border: gray solid 1px;width: 98%;margin: 5px;padding: 5px;">
    ...
    <div class="layui-row" style="margin-top: 20px;">
        <div class="layui-col-sm5">
            <form class="layui-form" action="/news/exUpdate" method="post" enctype="multipart/form-data">
               <input type="hidden" name="id" value="${obj.id}"/>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea value="${obj.context}" name="content" placeholder="请输入公告内容" class="layui-textarea" style="width: 300px;height: 200px"></textarea>
                    </div>
                </div>
                <%--                <div class="layui-form-item layui-form-text">--%>
