                    ...
                    <div class="layui-row">
                        <div class="layui-col-sm3">
                            <button class="layui-btn" lay-submit lay-filter="formDemo"
                                    onclick=" javascrtpt:window.location.href='${pageContext.request.contextPath}/news/add'">
                                <i class="layui-icon">&#xe624;</i>添加公告
                            </button>
                        </div>
                        <form class="layui-form" action="news/findBySql">
                ...
                <td>
                    <div class="layui-btn-group ">
                        ...
                        <button type="button" class="layui-btn"
                                onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/news/update?id=${data.id}'">
                            <i class="layui-icon">&#xe642;</i>修改
                        </button>
                        <button type="button" class="layui-btn layui-btn-danger"
                                onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/news/delete?id=${data.id}'">
            ...
            <td colspan="8">
                <div class="layui-row">
                    ...
                    <div class="pagelist layui-col-md4">
                        ...
                        <pg:pager url="news/findBySql" maxIndexPages="5" items="${pagers.total}"
                                  maxPageItems="15"
