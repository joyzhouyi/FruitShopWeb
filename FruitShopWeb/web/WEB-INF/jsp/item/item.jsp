                    ...
                    <div class="layui-row">
                        <div class="layui-col-sm3">
                            <button class="layui-btn" lay-submit lay-filter="formDemo"
                                    onclick=" javascrtpt:window.location.href='${pageContext.request.contextPath}/item/add'">
...
<div class="center" style="margin: 5px;">
    <table class="layui-table" lay-size="sm">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                <td>${data.name}</td>
                <td><img src="${pageContext.request.contextPath}/${data.url1}" alt=""
                ...
                <td>
                    <div class="layui-btn-group ">
                        ...
                        <button type="button" class="layui-btn"
                                onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/item/update?id=${data.id}'">
                            <i class="layui-icon">&#xe642;</i>修改
                        </button>
                        <button type="button" class="layui-btn layui-btn-danger"
                                onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/item/delete?id=${data.id}'">
            ...
            <td colspan="8">
                <div class="layui-row">
                    ...
                    <div class="pagelist layui-col-md4">
                        ...
                        <pg:pager url="item/findBySql" maxIndexPages="5" items="${pagers.total}"
                                  maxPageItems="15"
