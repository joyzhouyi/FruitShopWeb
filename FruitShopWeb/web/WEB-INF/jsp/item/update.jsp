...
<div style="border: gray solid 1px;width: 98%;margin: 5px;padding: 5px;">
    <div><i class="layui-icon layui-icon-edit" style="font-size: 20px; color: #010202;"></i><span
            style="font-size: 20px;">&nbsp;&nbsp;修改商品</span></div>

    <div class="layui-row" style="margin-top: 20px;">
        <div class="layui-col-sm5">
            <form class="layui-form" action="item/exUpdate" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="${obj.id}"/>
                <input type="hidden" name="url1" value="${obj.url1}"/>
                <input type="hidden" name="url2" value="${obj.url2}"/>
                <input type="hidden" name="url3" value="${obj.url3}"/>
                <input type="hidden" name="url4" value="${obj.url4}"/>
                <input type="hidden" name="url5" value="${obj.url5}"/>
                <div class="layui-form-item">
                    <label class="layui-form-label">商品名称：</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" required lay-verify="required" placeholder="请输入商品名称"
                               autocomplete="off" class="layui-input" value="${obj.name}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="price" required lay-verify="required" placeholder="请输入商品价格"
                               autocomplete="off" class="layui-input" value="${obj.price}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="zk" required lay-verify="required" placeholder="请输入商品折扣"
                               autocomplete="off" class="layui-input" value="${obj.zk}" >
                    </div>
                </div>
                <div class="layui-form-item">
